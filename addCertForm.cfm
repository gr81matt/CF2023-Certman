...
<h2 class="subheading"> SSL Certificates &gt; Certificate Management &gt; Add Certificate</h2>
				...
				<tr>
					<td colspan="2">
						<div class="grey-background-div">
							<input type="submit" name="AddCertificate" value="&nbsp; Add &nbsp;" class="buttn-grey buttn-green">&nbsp;&nbsp;<input type="button" name="Cancel" value="Cancel" onClick="document.location.href='index.cfm';" class="buttn-grey buttn-green">
						</div>
					</td>
				</tr>
				</table>
